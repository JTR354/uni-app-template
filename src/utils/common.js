...
// const SCENE_SHARE = 'share'
// const SCENE_QR_CODE = 'qr-code'
//
// // 判定场景值 0普通 1分享 2扫码
...
//   API.Login.getToken({ data: { code: codeJson.code }, loading: false, toast: false })
//     .then((tokenJson) => {
//       if (!tokenJson.data.customer_info.is_register) {
//         wx.reLaunch({ url: $$routes.other.LOGIN })
//         return
//       }
...
//       activeId = +params.activeId || +params.a || 0
//       shareAuthor = +params.shareAuthor || +params.sp || 0
//       shareActive = +params.shareActive || +params.sa || 0
//     } catch (e) {
//       console.error(e)
//     }
//   }
